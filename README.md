...
Developed During Data Science Internship at Unified Mentor Private Limited

# 📌 Overview

This project focuses on building, training, and deploying a Machine Learning model using Python, Scikit-learn. The end goal was to create a fully interactive web application where users can input values and get predictions instantly.

This project was developed as part of my 6-month Data Science Internship at Unified Mentor Pvt. Ltd.
...
If you want to collaborate or discuss ML projects, feel free to connect on LinkedIn!

Contact: www.linkedin.com/in/suryavhi-das-a95094351
